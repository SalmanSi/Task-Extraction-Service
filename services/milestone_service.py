...
Notes: 
- If any proposal document mentions that they plan to publish a paper in a journal or conference so, you must extract that as a task. The deadline for the conference should be clearly mentioned. If it is not mentioned, you MUST reject the extraction process, return a failed status and ask the user in message to provide the required details.
